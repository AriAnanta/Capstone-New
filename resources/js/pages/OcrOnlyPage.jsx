            ...
            <div className="bg-linear-to-r from-blue-600 via-indigo-600 to-purple-600 text-white shadow-xl">
                <div className="max-w-7xl mx-auto px-4 sm:px-8 py-8">
                    <div className="flex items-center gap-4 mb-2">
                        ...
                        <div>
                            <h1 className="text-3xl font-bold">OCR Dokumen</h1>
                            <p className="text-blue-100 mt-1">Upload dokumen untuk ekstraksi teks otomatis</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div className="grid lg:grid-cols-3 gap-8">
                    ...
                    <div className="lg:col-span-2 space-y-6">
                        ...
                        <div className="space-y-4">
                            ...
                            {data?.data?.map((doc) => (
                                <div key={doc.id} className="bg-white rounded-2xl shadow-xl border-2 border-blue-200 overflow-hidden hover:shadow-2xl transition-all duration-300">
                                    <div className="p-6">
                                        {/* Header */}
