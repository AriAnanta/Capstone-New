...
const LegalAdvisorPage = () => {
    ...
    return (
        <div className="min-h-screen bg-linear-to-br from-slate-50 via-amber-50/30 to-yellow-50/30 pt-6 px-4 sm:px-8">
            {/* Header */}
            <div className="relative overflow-hidden rounded-2xl bg-linear-to-br from-amber-600 via-yellow-600 to-orange-600 p-8 shadow-2xl shadow-amber-500/20 mb-8">
                ...
                <div className="absolute bottom-4 left-1/4 w-24 h-24 bg-yellow-300/20 rounded-full blur-2xl floating-delayed" />
