    ...
    return (
        <div className="min-h-screen bg-linear-to-br from-slate-50 via-amber-50/30 to-orange-50/30">
            <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-700">
                {/* Header */}
                <div className="relative overflow-hidden rounded-2xl bg-linear-to-br from-amber-500 via-orange-500 to-rose-500 p-6 shadow-2xl shadow-amber-500/20">
                    ...
                    <div className="lg:col-span-2 space-y-6">
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                >
                                    <Upload className="mr-2 h-4 w-4" /> Unggah & Jalankan Pipeline
                                </Button>
